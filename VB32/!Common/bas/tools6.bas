...
Public Function fileExists(ByVal File2Look4 As String, Optional ByRef oError As clsError) As Boolean
...
Public Function dirExists(ByVal sPathName As String, Optional ByRef oError As clsError) As Boolean
...
Public Function ctlSetEditStyle( _
    ...
    SetWindowLong hWnd, GWL_STYLE, GetWindowLong(hWnd, GWL_STYLE) Or eStyle
